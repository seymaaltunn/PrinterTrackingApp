...
{
    public class TonerOlcumRepository
    {
        public void Add(TonerOlcumu olcum)
        {
            using var connection = DbConnectionFactory.CreateConnection();
            connection.Open();

            const string query = @"
                INSERT INTO toner_olcumleri
                (yazici_id, renk, seviye_yuzde, olcum_zamani,
            ...
            command.Parameters.AddWithValue("@renk", olcum.Renk);
        ...
        public List<TonerLogDto> GetLoglar(DateTime baslangic, DateTime bitis, string? ipAdresi)
        {
            var liste = new List<TonerLogDto>();
            using var connection = DbConnectionFactory.CreateConnection();
            connection.Open();

            const string query = @"
                SELECT o.id, o.yazici_id, y.ip_adresi, y.marka, y.model,
                       o.renk, o.seviye_yuzde, o.olcum_zamani, o.veri_kaynagi
